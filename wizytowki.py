...
class BaseContact:
    ...
    def __init__(self, owner_name, owner_surname, owner_e_mail, owner_private_number, **kwargs):
...
class BusinessContact(BaseContact):
    def __init__(self, owner_name, owner_surname, owner_e_mail, owner_private_number, 
                 owner_firm_name, owner_position, owner_business_number, **kwargs):
        super().__init__(
...
def create_contacts():
    ...
    choice_card_number = int_input("Wpisz ile wizytówek chcesz stworzyć: ")
    if choice_card == 1:
